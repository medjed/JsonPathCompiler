...
public class FilterParseTest {
    ...
    public void a_type_filter_can_be_serialized() {
        Assertions.assertThat(filter(Criteria.where("a").type(String.class)).toString()).isEqualTo("[?(@['a'] TYPE java.lang.String)]");
    }
    ...
    public void a_matches_filter_can_be_serialized() {
        ...
        Assertions.assertThat(filter(Criteria.where("a").matches(a)).toString()).isEqualTo("[?(@['a'] MATCHES [?(@['x'] == 1000)])]");
    }
    ...
    public void a_regex_filter_can_be_serialized() {
        Assertions.assertThat(filter(Criteria.where("a").regex(Pattern.compile("/.*?/i"))).toString()).isEqualTo("[?(@['a'] =~ /.*?/i)]");
    }
