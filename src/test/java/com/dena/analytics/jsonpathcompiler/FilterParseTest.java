...
public class FilterParseTest {
    ...
    public void a_gte_filter_can_be_serialized() {
        ...
        String filter = filter(Criteria.where("a").gte(1)).toString();
    ...
    public void a_lte_filter_can_be_serialized() {
        ...
        String filter = filter(Criteria.where("a").lte(1)).toString();
        String parsed = parse("[?(@['a'] <= 1)]").toString();
    ...
    public void a_eq_filter_can_be_serialized() {
        ...
        String filter = filter(Criteria.where("a").eq(1)).toString();
        String parsed = parse("[?(@['a'] == 1)]").toString();
    ...
    public void a_ne_filter_can_be_serialized() {
        ...
        String filter = filter(Criteria.where("a").ne(1)).toString();
        String parsed = parse("[?(@['a'] != 1)]").toString();
    ...
    public void a_lt_filter_can_be_serialized() {
        ...
        String filter = filter(Criteria.where("a").lt(1)).toString();
        String parsed = parse("[?(@['a'] < 1)]").toString();
    ...
    public void a_gt_filter_can_be_serialized() {
        ...
        String filter = filter(Criteria.where("a").gt(1)).toString();
        String parsed = parse("[?(@['a'] > 1)]").toString();
    ...
    public void a_nin_filter_can_be_serialized() {
        String filter = filter(Criteria.where("a").nin(1)).toString();
    ...
    public void a_in_filter_can_be_serialized() {
        ...
        String filter = filter(Criteria.where("a").in("a")).toString();
    ...
    public void a_contains_filter_can_be_serialized() {
        String filter = filter(Criteria.where("a").contains("a")).toString();
    ...
    public void a_all_filter_can_be_serialized() {
        ...
        String filter = filter(Criteria.where("a").all("a", "b")).toString();
    ...
    public void a_size_filter_can_be_serialized() {
        ...
        String filter = filter(Criteria.where("a").size(5)).toString();
    ...
    public void a_exists_filter_can_be_serialized() {
        ...
        Filter a = filter(Criteria.where("a").exists(true));
    ...
    public void a_not_exists_filter_can_be_serialized() {
        ...
        String filter = filter(Criteria.where("a").exists(false)).toString();
        String parsed = parse("[?(!@['a'])]").toString();
    ...
    public void a_type_filter_can_be_serialized() {
        assertThat(filter(Criteria.where("a").type(String.class)).toString()).isEqualTo("[?(@['a'] TYPE java.lang.String)]");
    }

    @Test
    public void a_matches_filter_can_be_serialized() {
        Filter a = filter(Criteria.where("x").eq(1000));

        assertThat(filter(Criteria.where("a").matches(a)).toString()).isEqualTo("[?(@['a'] MATCHES [?(@['x'] == 1000)])]");
    }

    @Test
    public void a_not_empty_filter_can_be_serialized() {

        String filter = filter(Criteria.where("a").empty(false)).toString();
    ...
    public void and_filter_can_be_serialized() {
        ...
        String filter = filter(Criteria.where("a").eq(1).and("b").eq(2)).toString();
    ...
    public void in_string_filter_can_be_serialized() {
        ...
        String filter = filter(Criteria.where("a").in("1","2")).toString();
    ...
    public void a_deep_path_filter_can_be_serialized() {
        ...
        String filter = filter(Criteria.where("a.b.c").in("1", "2")).toString();
    ...
    public void a_regex_filter_can_be_serialized() {
        assertThat(filter(Criteria.where("a").regex(Pattern.compile("/.*?/i"))).toString()).isEqualTo("[?(@['a'] =~ /.*?/i)]");
    }
    ...
    public void and_combined_filters_can_be_serialized() {
        ...
        Filter a = filter(Criteria.where("a").eq(1));
        Filter b = filter(Criteria.where("b").eq(2));
        Filter c = a.and(b);
